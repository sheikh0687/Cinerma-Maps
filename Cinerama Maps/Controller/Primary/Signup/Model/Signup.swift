...
struct Api_Signup : Codable {
    let result : Res_Signup?
    let message : String?
    let status : String?
    ...
    init(from decoder: Decoder) throws {
        ...
        result = try values.decodeIfPresent(Res_Signup.self, forKey: .result)
        message = try values.decodeIfPresent(String.self, forKey: .message)
        status = try values.decodeIfPresent(String.self, forKey: .status)
    }
}

struct Res_Signup : Codable {
    let id : String?
    ...
    init(from decoder: Decoder) throws {
        ...
        subcription = try values.decodeIfPresent(String.self, forKey: .subcription)
    }
