...
struct Api_MoreAboutTrip : Codable {
    let result : [Res_MoreAboutTrip]?
    let message : String?
    let status : String?
    ...
    init(from decoder: Decoder) throws {
        ...
        result = try values.decodeIfPresent([Res_MoreAboutTrip].self, forKey: .result)
        message = try values.decodeIfPresent(String.self, forKey: .message)
        status = try values.decodeIfPresent(String.self, forKey: .status)
    }
}

struct Res_MoreAboutTrip : Codable {
    let id : String?
    let day_name : String?
    let day_name_ar : String?
    let date_time : String?
    let day_wise_trip : [Day_wise_trip]?
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case day_wise_trip = "day_wise_trip"
    }
    ...
    init(from decoder: Decoder) throws {
        ...
        day_wise_trip = try values.decodeIfPresent([Day_wise_trip].self, forKey: .day_wise_trip)
    }
}

struct Day_wise_trip : Codable {
    let id : String?
    let user_id : String?
